...
public class ReflectionDemo {
    ...
    public static void PrintClass(String[] args) {
        if (args.length != 1) {
            System.out
        ...
        try {
            ...
            String[] innerClassList = new String[classObj.getDeclaredClasses().length];
            for (int i = 0; i <= innerClassList.length - 1; i++) {
                Class inner = classObj.getDeclaredClasses()[i];
                innerClassList[i] = inner.getName();

            }
            //classObj.getDeclaredClasses()[0].getName();
            PrintClass(innerClassList);
